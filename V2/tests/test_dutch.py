...
class Env:
    ...
    def deploy_normalizer(self):
        ...
        with open("data.json", encoding="UTF-8") as json_file:
            json_storage = json_file.read()
        storage = json.loads(json_storage)
    ...
    def deploy_marketplace_app(
        ...
        return nft, foreign_nft, royalties_contr, marketplace, normalizer, usd_fa12
...
class TestMarketplace(unittest.TestCase):
    def test_add_to_marketplace(self):
        ...
        nft, foreign_nft, royalties_contr, marketplace, normalizer, usd_fa12 = Env().deploy_marketplace_app(
            nft_init_storage, royalties_init_storage, marketplace_init_storage, fa12_init_storage
        )
    ...
    def test_collect(self):
        ...
        resp = (
            ...
            .collect({"swap_id": swap_id, "token_amount": 1, "token_symbol": 0, "amount_ft": current_price})
